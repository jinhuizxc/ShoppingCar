package com.example.jinhui.shoppingcar.widget;
...
public class ZQRoundOvalImageView extends AppCompatImageView {
    ...
    public ZQRoundOvalImageView(Context context, AttributeSet attrs, int defStyleAttr) {
